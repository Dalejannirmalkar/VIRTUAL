...
public class MainActivity extends AppCompatActivity
    ...
    ImageView pdf, video, document, other;
    String app_server_url = "http://www.sonalneelima.esy.es/kuch.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        showselecteditem();
        pdf = (ImageView) findViewById(R.id.pdfimage);
        video = (ImageView) findViewById(R.id.videoimage);
        document = (ImageView) findViewById(R.id.documentimage);
        other = (ImageView) findViewById(R.id.otherimage);
